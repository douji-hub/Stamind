...
// Email error msg
export const getEmailErrorMessages = (emptyEmail: boolean, hasTyped: boolean) => {
    return {
...
// Username error msg
export const getUsernameErrorMessages = (emptyUsername: boolean, hasTyped: boolean) => {
    return {
        hasError: hasTyped && emptyUsername,
        errorMessages: hasTyped && emptyUsername ? ["Username cannot be empty."] : [],
    };
};
...
export const getPasswordErrorMessages = (errors: Errors, hasTyped: boolean) => {
    ...
    const errorMessages = [
        ...
        !errors.specialChar && "It must include special characters (e.g., !, @, #, etc.).",
...
export const getConfirmPasswordErrorMessages = (
    ...
    return {
        ...
        errorMessages: hasTyped && !match ? ["Passwords do not match. Please try again."] : [],
    };
};
